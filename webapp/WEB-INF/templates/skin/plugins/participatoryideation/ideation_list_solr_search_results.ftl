		...
		<div id="prop-list" class="row">
			...
			<#list results_list as result>
				...
				<#if (result.dynamicFields.code_theme_string)??>
					<#assign theme_libelle = (campaign_data['theme_list']?filter( i -> i.code = result.dynamicFields.code_theme_string )[0].name)!result.dynamicFields.code_theme_string >
							...
							<div class="prop-card-footer">
								...
								<div class="deposit">
									<#if result.dynamicFields?? && result.dynamicFields.pseudo_string?? >
										...
										<span>
											<a href="jsp/site/Portal.jsp?page=search-solr&conf=list_proposals&query=(pseudo_string:&quot;${result.dynamicFields.pseudo_string?html!''}&quot;)" title="Voir les propositions déposées par ${result.dynamicFields.pseudo_string?html!''} (nouvel onglet)">
