		...
		<#else>
			...
			<#else>
				...
				<#if proposal.codeTheme??>
					...
					<#assign proposal_theme_libelle = (campaign_static['theme_list']?filter( i -> i.code = proposal.codeTheme )[0].name)!proposal.codeTheme >
				...
				<div id="prop-body" class="row" style="border: 4px solid ${theme_front_color}">
					...
					<div id="prop-data" class="col-xs-12 col-sm-4">
						...
						<#if proposal.handicap?? && proposal.handicap == "yes">
							<div id="prop-data-handicap">
								#i18n{participatoryideation.view_idea.data.handicap} 
							</div>
						</#if>
						...
						<div id="prop-data-avatar">
							...
							<a href="jsp/site/Portal.jsp?page=search-solr&conf=list_proposals&query=(pseudo_string:&quot;${(nickname!'')?url('UTF-8')}&quot;)" class="color-theme-autre" target="_blank" title="Voir les propositions déposées par ${nickname!''} (nouvel onglet)">
								${nickname!''}
							</a>
						</div>
