...
INSERT INTO `core_datastore` (`entity_key`, `entity_value`) VALUES ('participatoryideation.site_property.view_proposal.site_properties.contact_message_content.textblock', '${nom_depositaire}, ${nom_contacteur}, ${message}');
